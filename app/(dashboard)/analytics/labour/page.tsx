...
export default function LabourAnalyticsPage() {
  ...
  const kpis = [
    { label: 'Total Policies',      value: total,   color: ACCENT,    icon: <GroupsIcon /> },
  ...
  return (
    <Box>
      <Breadcrumbs sx={{ mb: 1 }}>
        ...
        <Typography color="text.primary">Labour Analytics</Typography>
      </Breadcrumbs>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 3, flexWrap: 'wrap', gap: 1 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
          ...
          <Box>
            <Typography variant="h5" sx={{ fontWeight: 700 }}>Labour Insurance Analytics</Typography>
            <Typography variant="body2" color="text.secondary">Overview of all labour insurance policies</Typography>
          </Box>
        </Box>
        <Button variant="outlined" size="small" component={NextLink} href="/labour-records"
        ...
        <Grid container spacing={3}>
          ...
          <Grid size={{ xs: 12, md: 5 }}>
            <Paper sx={{ p: 2.5, borderRadius: 2, height: '100%' }}>
              ...
              <Typography variant="caption" color="text.secondary" sx={{ display: 'block', mb: 2 }}>{total} total labour policies</Typography>
              <Divider sx={{ mb: 2.5 }} />
            ...
            <Paper sx={{ p: 2.5, borderRadius: 2 }}>
              <Box sx={{ display: 'flex', gap: 1.5, flexWrap: 'wrap', alignItems: 'center' }}>
                <Button variant="contained" disableElevation size="small"
                  ...
                  component={NextLink} href="/labour-records/add">Add Labour Policy</Button>
                <Button variant="outlined" size="small" component={NextLink} href="/labour-records">View All Records</Button>
                <Button variant="outlined" size="small" color="warning" startIcon={<WarningAmberIcon />}
                  component={NextLink} href="/labour-records/expiring">Expiring Policies</Button>
                <Button variant="outlined" size="small" color="error" startIcon={<EventBusyIcon />}
                  component={NextLink} href="/labour-records/expired">Expired Policies</Button>
              </Box>
            </Paper>
          </Grid>
        </Grid>
